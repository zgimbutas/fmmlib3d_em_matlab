...
[evec, hvec, evectarg, hvectarg] = emtools(mex_id_, zk, nsource, source, ifcjvec, cjvec, rho_e, ifcmvec, cmvec, rho_m, ifevec, evec, ifhvec, hvec, ntarget, target, ifevectarg, evectarg, ifhvectarg, hvectarg, 1, 1, 1, 1, 1, 1, 1, 1, 1);
