...
[evec, hvec, evectarg, hvectarg] = emtools(mex_id_, zk, nsource, source, ifcjvec, cjvec, ifcmvec, cmvec, ifevec, evec, ifhvec, hvec, ntarget, target, ifevectarg, evectarg, ifhvectarg, hvectarg, 1, 1, 1, 1, 1, 1, 1, 1, 1);
